...
urlpatterns = [
    ...
    path(
        'hazards/<slug:slug>/comments/<int:comment_id>/delete/',
        views.hazard_comment_delete, name='hazard_comment_delete'),
    path(
        'outcomes/<slug:slug>/comments/<int:comment_id>/delete/',
        views.outcome_comment_delete, name='outcome_comment_delete'),
]
